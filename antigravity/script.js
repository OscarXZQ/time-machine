...
document.body.style.border = "5px solid red"; // Visual debug cue
...
class ParticleSystem {
    constructor(canvasId) {
        // Reuse the same canvas context or create a new layer? 
        // For simplicity, let's just hook into the existing canvas or create a new one.
        // Actually, let's just add particles to the WormholeRenderer to keep it simple and performant.
        // But since I can't easily modify the constructor of WormholeRenderer without replacing the whole class,
        // I'll stick to a separate logic but maybe draw on the same canvas if I had access.
        // Let's create a new canvas layer for particles to be safe and clean.
